...
def get_text_length(text: str) -> int:
    """
    This function strips all non-alphabetic characters from the input text and then returns the length of the resulting text.
    Args:
        text (str): The input text to process.
    Returns:
        int: The length of the text after removing non-alphabetic characters.
    """
